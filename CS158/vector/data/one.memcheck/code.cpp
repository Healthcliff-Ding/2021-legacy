...
void TestAccessingMethod()	//这个块也没有内存泄漏
{
...
int main(int argc, char const *argv[])	// one 没有 mem_leak
{
	TestConstructor();
	TestIterators();
	TestAccessingMethod();
